...
import { createFacturaSchema, updateFacturaSchema } from "../validations/facturasValidator.js";
...
facturaCompraRouter.get(
  "/buscar/concepto",
  FacturaCompraController.getByConcepto,
);
facturaCompraRouter.get("/:id", FacturaCompraController.getById);
// ----- \\

facturaCompraRouter.post("/", validate(createFacturaSchema), FacturaCompraController.create);
facturaCompraRouter.patch("/:id", validate(updateFacturaSchema), FacturaCompraController.update);
